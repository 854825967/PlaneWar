...
bool CTouchEngine::init() {
    ECHO("CTouchEngine::init");
    m_pListener = NULL;
    return Layer::init();
}

void CTouchEngine::onEnter() {
    ECHO("CTouchEngine::onEnter");
    Layer::onEnter();
...
void CTouchEngine::onExit() {
    ECHO("CTouchEngine::onExit");
    Layer::onExit();
    _eventDispatcher->removeAllEventListeners();
}

bool CTouchEngine::AddTouchHandle(const CTouchGrade grade, ITouchHandler * pHandle) {
...
bool CTouchEngine::RemoveTouchHandle(ITouchHandler * pHandle) {
...
bool CTouchEngine::dealTouch(const s8 index, const CCPoint & point, const CTouchGrade grade, const CTouchEventType eventType) {
    bool res = false;
    switch(eventType) {
    case TOUCH_EVENT_BEGAN:
        {
            ITouchHandler * pHandle = NULL;
